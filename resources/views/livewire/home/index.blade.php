<div class="min-h-screen bg-gray-900">
    <div id="hero" class="flex flex-col lg:flex-row w-full text-white items-center bg-gradient-to-r from-black via-transparent to-black p-6">
        <div class="h-auto sm:max-w-full md:w-full  lg:flex-1/2 items-start flex flex-col gap-2 px-auto">
            <span class="text-sm font-semibold bg-red-500 rounded-md p-1">Film Populer</span>
            <h1 class="font-sans font-normal text-4xl">Judul Film</h1>
            ...
            <p class="font-normal">Knight is not the people never fall, but the ones can get riese and rise </p>
